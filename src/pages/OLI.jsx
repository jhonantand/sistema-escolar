...
const STORAGE_KEY = "oli_dados";
const STORAGE_VENCIMENTO_KEY = "oli_vencimento_geral";
const STORAGE_COTA_KEY = "oli_cota";

const alunosOLIBase = [
  "Ana Beatriz Severo De Sousa",
  "Ana Flavia Cavalcante Barreto",
  "Ana Kelly Barrozo Silva",
  "Anabelle Gomes Siqueira",
  "Anna Vitoria Martins Lima",
  "Arthur Alves Lacerda",
  "Arthur da Silva Moura dos Santos",
  "Arthur Brito Chayn",
  "Daniel Benevenuto Albuquerque",
  "Gabriela Cavalcante Rodrigues",
  "Gabriela Ricardo Da Silva",
  "Heloísa Oliveira Nunes Fiuza",
  "Hildegardo Nojosa de Freitas",
  "Isabelle Rianne Alves Soares",
  "João Nicolas dos Santos Uchôa",
  "João Paulo Santana Nascimento",
  "João Victor Mourão Venâncio",
  "João Vitor Arruda Holanda",
  "Karoline Cavalcante Gomes",
  "Kauã Enzo Lima Fernandes",
  "Laís Oliveira Gomes",
  "Lara Clarisse Teixeira Gomes",
  "Lucas José Gomes Pereira",
  "Luis Felipe Oliveira Lopes",
  "Luiz Guilherme Alcântara",
  "Luiza Ribeiro de Souza",
  "Maria Celeste de Menezes",
  "Maria Clara Uchoa Moita",
  "Marília Aguiar Moreira",
  "Matheus Freitas Texeira",
  "Mikaelly Ximenes do Prado",
  "Milena Rianne Loureiro Gomes",
  "Pedro Manoel Sousa Pinto",
];

function criarListaInicial() {
  return alunosOLIBase.map((nome) => ({
    nome,
    valor: "",
    cota: "",
    dataPagamento: "",
...
function OLI() {
  ...
  const novaQuinzena = () => {
    ...
    if (totalArrecadado > 0) {
      financeiroAtual.push({
        tipo: "Entrada",
        categoria: "Cotas",
        descricao: "Arrecadação automática da nova quinzena - OLI",
  ...
  return (
    <div style={{ color: "#fff" }}>
      <h1 style={{ marginBottom: "20px" }}>Turma 2º OLI</h1>
