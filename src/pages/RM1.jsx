...
const STORAGE_KEY = "rm1_dados";
const STORAGE_VENCIMENTO_KEY = "rm1_vencimento_geral";
const STORAGE_COTA_KEY = "rm1_cota";

const alunosRM1Base = [
  "adaiton  moreira da silva",
  "Amanda Aires Barbosa",
  "Amanda Emily de Oliveira Alencar",
  "Ana Licia Passos de Oliveira",
  "Anna Sophia dos Santos Rabelo",
  "anna clara  barbosa saraiva",
  "Antonio Alves da Silva Neto",
  "Bárbara Hellen Lima Saraiva",
  "Carolina Oliveira Moreira",
  "Daniel Luca Lemos Sales",
  "Davi de Souza Bezerra",
  "Davi Henrique de Oliveira Facundo",
  "Elisa Nicoly Saldanha Sousa",
  "Gabriel Mendes Lopes",
  "Gisely Sobrinho Silva",
  "Heytor Araújo de Souza Oliveira",
  "Isabelly da Silva Germano",
  "Jhonantan Dias da Cruz",
  "Joel Silva Mendes",
  "Joyce arrace novata",
  "Karoline Isabele Capistrano Silva",
  "Laura Joyce Sousa Brito",
  "Lorrana Drielly do Nascimento Barroso",
  "Luis Guilherme Felipe Blini",
  "Maria de Fátima Viana",
  "Maria Eliza Ponciano Berisha",
  "Maria Izabele Martins de Castro",
  "Melissa Colares Gamarano",
  "Maria Luiza Marques Accioly",
  "Mariane Firmino Pereira",
  "Moises Ferreira Souto",
  "Nicolle de Sousa Cabral",
  "Naylane Costa Barros",
  "Nicolly Amaro Holanda",
  "Nivia Rodrigues Nobre Menezes",
  "Pedro lucas Oliveira de Queiróz",
  "Petrus José da Costa Evangelista",
  "Riana Thaila Mota Lima",
  "Yasmin da Silva Gomes",
  "Yasmin Rodrigues Feitosa",
];

function criarListaInicial() {
  return alunosRM1Base.map((nome) => ({
    nome,
    valor: "",
    cota: "",
    dataPagamento: "",
...
function RM1() {
  ...
  const novaQuinzena = () => {
    ...
    if (totalArrecadado > 0) {
      financeiroAtual.push({
        tipo: "Entrada",
        categoria: "Cotas",
        descricao: "Arrecadação automática da nova quinzena - RM1",
  ...
  return (
    <div style={{ color: "#fff" }}>
      <h1 style={{ marginBottom: "20px" }}>Turma 2º RM1</h1>
